...
public class StatementSendManagementController {
    ...
    public ResponseEntity<List<Map<String, Object>>> logs(
        ...
        result.sort(
                Comparator.comparing(
                        row -> String.valueOf(row.getOrDefault("sentAt", "")),
    ...
    public ResponseEntity<Map<String, Object>> delete(
        ...
        for (Object entity : entities) {
            ...
            if (id.equals(String.valueOf(readId(entity)))) {
                target = entity;
                break;
            }
        }
    ...
    private Object findDeliveryLogRepository() {
        ...
        for (String beanName : beanNames) {
            ...
            if (
                    normalized.contains("statementdeliverylog")
    ...
    private String readMonth(Object entity) {
        Object value = readValue(
                entity,
                "month",
                "statementMonth",
    ...
    private String readSentAt(Object entity) {
        Object value = readValue(
                entity,
                "sentAt",
                "createdAt",
    ...
    private String readVendorName(Object entity) {
        Object directName = readValue(
                entity,
                "vendorName",
                "statementName"
        );
        ...
        if (vendor != null) {
            ...
            Object vendorId = readValue(vendor, "id");
            if (vendorId != null) {
                return "거래처 #" + vendorId;
            }
        }

        Object vendorId = readValue(
                entity,
                "vendorId"
        );
    ...
    private Object readValue(
        ...
        for (String name : names) {
            try {
                Method direct = target.getClass().getMethod(name);
